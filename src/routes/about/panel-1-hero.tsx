    ...
    <section className="relative -mt-28 min-h-screen flex items-center overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6">
        ...
        >
          ...
          <span className="text-xs uppercase tracking-[0.3em] text-muted-foreground">About Lightwarp</span>
        </motion.div>
        ...
        <div className="grid items-center gap-16 lg:grid-cols-[1fr_0.95fr]">
          ...
          >
            ...
            <div className="mt-16 grid gap-4 sm:grid-cols-3">
              {[
                { title: "Creative", desc: "Driven by cinematic storytelling" },
                { title: "Innovative", desc: "Powered by modern realtime tech" },
                { title: "Global", desc: "Collaborating across industries" },
              ].map((item) => (
          ...
          >
            ...
            <div className="relative overflow-hidden rounded-[40px] border border-white/10 bg-white/[0.04] backdrop-blur-2xl">
              ...
              <div className="relative h-[640px] overflow-hidden">
                ...
                >
                  <div className="text-xs uppercase tracking-[0.25em] text-muted-foreground">Since 2018</div>
                  <div className="mt-2 text-2xl font-semibold">Creative Studio</div>
                  <div className="mt-2 text-sm text-muted-foreground">Crafting cinematic digital experiences with creativity and technology.</div>
                </motion.div>
                ...
                >
                  <div className="text-xs uppercase tracking-[0.2em] text-muted-foreground">Global Creative Team</div>
                  <div className="mt-2 text-3xl font-semibold text-gradient">180+ Projects</div>
                </motion.div>
              ...
              >
                <div className="text-xs uppercase tracking-[0.25em] text-muted-foreground">Since 2018</div>
                <h3 className="mt-3 text-xl font-semibold">Built From Passion</h3>
                <p className="mt-2 text-sm text-muted-foreground">
                  Started with a vision to transform storytelling through cinematic digital experiences.
                </p>
              </motion.div>
              ...
              >
                <div className="text-xs uppercase tracking-[0.2em] text-muted-foreground">Creative Journey</div>
                <div className="mt-2 text-3xl font-semibold text-gradient">180+ Projects</div>
              </motion.div>
              ...
              >
                <span className="text-sm font-medium text-white">Creative Lighthouse</span>
              </motion.div>
            </div>
          </motion.div>
        </div>
